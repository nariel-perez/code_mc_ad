...
module AdsorbateInput
   ...
   real,    public           :: XT       = 0.0    ! suma de fracciones
   real,    allocatable, public :: X(:)           ! fracción de cada especie
   integer, allocatable, public :: NATOM(:), NTOTAL(:), NMIN2(:), NMAXI2(:)
   real,    allocatable, public :: RX0(:,:), RY0(:,:), RZ0(:,:)
